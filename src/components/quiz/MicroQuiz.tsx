  ...
  if (quizCompleted) {
    return (
      <div className="max-w-2xl mx-auto py-12">
        <Card className="text-center p-8 border-2 border-blue-100 shadow-lg bg-gradient-to-b from-white to-blue-50/50">
          <motion.div
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="mb-6 flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Micro-Quiz</h2>
          <p className="text-slate-500 mt-2">Test your knowledge of the election process.</p>
        </div>
        ...
        <CardContent className="p-6">
          <div className="space-y-3">
            {currentQuestion.options.map((option, idx) => {
              ...
              if (isSelected && !isSubmitted) optionClass = "border-blue-500 bg-blue-50 ring-1 ring-blue-500";
              if (isSubmitted) {
                if (isCorrect) optionClass = "border-green-500 bg-green-50 text-green-800";
                else if (isSelected && !isCorrect) optionClass = "border-red-500 bg-red-50 text-red-800 opacity-70";
          ...
          <AnimatePresence>
            {isSubmitted && (
              ...
              >
                ...
                <p className="text-sm text-blue-900 mt-1">{currentQuestion.explanation}</p>
              </motion.div>
            )}
          </AnimatePresence>
        </CardContent>
