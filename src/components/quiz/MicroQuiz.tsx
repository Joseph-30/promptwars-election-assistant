  ...
  return (
    <div className="flex-1 max-w-[720px] mx-auto w-full">
      ...
      <div className="bg-white rounded-xl p-lg shadow-quiz-card border-t-4 border-secondary">
        ...
        <div className="space-y-md">
            {currentQuestion.options.map((option, idx) => {
              ...
              return (
                ...
                >
                  <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center font-bold shrink-0 ${iconClass}`}>
                    {letter}
                  </div>
                  <span className={`font-quiz-option text-quiz-option text-on-surface ${textClass}`}>
                    {option}
                  </span>
        ...
        <AnimatePresence>
          {isSubmitted && (
            <motion.div
              ...
              className="mt-lg p-lg bg-secondary-fixed/10 border border-secondary/20 rounded-lg"
            >
        ...
        {/* Navigation Actions */}
        <div className="mt-xl flex flex-col sm:flex-row justify-end items-center gap-md">
