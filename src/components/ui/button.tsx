    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-primary text-white hover:bg-primary-container hover:text-white": variant === "default",
            ...
            "bg-secondary text-white hover:bg-secondary-container hover:text-secondary-container-foreground": variant === "secondary",
